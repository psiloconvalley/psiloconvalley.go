...
var es = T{
	...
	PricingNoticeSendLimit:     "Alcanzaste el límite gratuito de 3 envíos por mes. Sube a Growth para seguir enviando facturas profesionales.",
	PricingNoticeEstimateLimit: "Alcanzaste el límite gratuito de 3 presupuestos por mes. Sube a Growth para ganar más trabajos.",
	PricingNoticeReportLimit:   "Los reportes detallados son una función de Growth. Sube de plan para ver el análisis de tu negocio.",
	PricingNoticePayments:      "Aceptar pagos con tarjeta vía Stripe está disponible en Growth y superior. Sube de plan para que te paguen más rápido.",
	...
	PricingNoticeEmailPro:      "Alcanzaste el límite de envíos de correo este mes. Sube de plan para enviar más facturas.",
	PricingNoticeExpenses:      "El control de gastos está disponible en Growth y superior. Sube de plan para rastrear gastos y ver tu ganancia real.",
	PricingNoticeSuccess:       "Pago recibido. Tu plan ha sido actualizado. Bienvenido al siguiente nivel.",
	PricingNoticeCanceled:      "El pago fue cancelado. No se realizó ningún cargo.",
	PricingNoticeAlreadyPro:    "Ya estás en el plan Pro.",

	// Pricing page — hero
	PricingEyebrow:   "Precios Claros",
	PricingHeroTitle: "Empieza Gratis. Crece Cuando Estés Listo.",
	PricingHeroSub:   "Tres planes diseñados para donde estás ahora. Sin cargos ocultos. Cancela cuando quieras.",
	...
	PricingGrowthFoundingTag:   "Precio de Fundador — Asegúralo Ahora",
	...
	PricingProTitle:         "Pro",
	PricingProUnit:          "/ mes",
	PricingProSub:           "Escala ilimitada. Sin fricciones. Automatización total.",
	PricingProInvoices:      "Facturas ilimitadas",
	PricingProEstimates:     "Presupuestos ilimitados",
	PricingProClients:       "Clientes ilimitados",
	PricingProEmails:        "Envíos de correo ilimitados",
	...
	PricingProRecurring:     "Automatización de facturas recurrentes",
	PricingProReminders:     "Recordatorios automáticos de pago",
	...
	PricingProCtaRegister:   "Crear Cuenta Gratis",
	...
	HomeEyebrowQuotes:    "Cotizaciones",
	HomeEyebrowInvoices:  "Facturas",
	HomeEyebrowPayments:  "Pagos",
	HomeEyebrowGetPaid:   "Cobra",
	HomeHeroLine1:        "Ya hiciste el trabajo.",
	HomeHeroLine2:        "Ahora cobra por él.",
	HomeHeroSub:          "Envía una factura o cotización profesional en minutos. Tu cliente paga con tarjeta — el dinero va directo a ti. Hecho para negocios independientes que viven de su reputación.",
	HomeHeroCTA:          "Empieza Gratis →",
	HomeHeroSecondaryCTA: "Mira cómo funciona ↓",
	HomeHeroNote:         "No se requiere tarjeta de crédito.",
	HomeHeroNoteBold:     "Gratis para empezar.",
	HomeTrustSend:        "60s",
	HomeTrustSendLabel:   "Para enviar",
	HomeTrustStart:       "$0",
	HomeTrustStartLabel:  "Para empezar",
	HomeTrustPDF:         "PDF",
	HomeTrustPDFLabel:    "Descarga instantánea",
	HomeTrustTrackers:    "Sin",
	HomeTrustTrackLabel:  "Rastreadores",
	HomeTrustStripe:      "Stripe",
	HomeTrustStripeLabel: "Pagos con tarjeta",
	HomeICPContractors:   "Contratistas",
	HomeICPPool:          "Piscinas",
	HomeICPLandscapers:   "Jardineros",
	HomeICPPainters:      "Pintores",
	HomeICPElectricians:  "Electricistas",
	HomeICPHandymen:      "Mantenimiento",
	HomeICPPhotographers: "Fotógrafos",
	...
	// Home — steps section
	HomeStepsTitle:      "Cómo funciona",
	HomeStepsHeadline:   "Dos formas de cobrar. Tú eliges.",
	HomeStepsPathALabel: "⚡ Trabajo terminado — envía el cobro",
	HomeStepsA1Title:    "Crea una factura",
	HomeStepsA1Desc:     "Agrega tu cliente, describe el trabajo, pon el precio. Tarda 60 segundos.",
	HomeStepsA2Title:    "Envíala",
	HomeStepsA2Desc:     "Por correo o comparte un enlace. Tu cliente recibe un documento profesional al instante.",
	HomeStepsA3Title:    "Cobra",
	HomeStepsA3Desc:     "Pagan con tarjeta. El dinero va directo a tu cuenta.",
	HomeStepsDivider:    "o",
	HomeStepsPathBLabel: "📋 Necesitas aprobación primero — envía una cotización",
	HomeStepsB1Title:    "Envía una cotización",
	HomeStepsB1Desc:     "Acuerda el precio antes de empezar. El cliente aprueba con un toque — sin necesidad de cuenta.",
	HomeStepsB2Title:    "Haz el trabajo",
	HomeStepsB2Desc:     "Lo tienes por escrito. Sin sorpresas para ninguno.",
	HomeStepsB3Title:    "Convierte y cobra",
	HomeStepsB3Desc:     "Un toque convierte la cotización aprobada en factura. Envíala. Cobra.",
	HomeFeat1Title:      "PDF Instantáneo",
	HomeFeat1Desc:       "Generación de PDF de alta calidad en segundos",
	HomeFeat2Title:      "Sin rastreo",
	HomeFeat2Desc:       "Tus datos son tuyos. Sin analíticas.",
	HomeFeat3Title:      "Listo para móvil",
	HomeFeat3Desc:       "Crea facturas desde cualquier dispositivo",
	HomeFeat4Title:      "Envío por correo",
	HomeFeat4Desc:       "Envía facturas directamente a tus clientes",
	HomeFeat5Title:      "Guarda clientes",
	HomeFeat5Desc:       "Reutiliza la info del cliente en futuras facturas",
	HomeFeat6Title:      "Tu marca",
	HomeFeat6Desc:       "Agrega tu logo y datos de empresa",
	HomeFeat7Title:      "Cotizaciones inteligentes",
	HomeFeat7Desc:       "Envía una cotización. El cliente aprueba con un toque — sin cuenta necesaria.",
	HomeFeat8Title:      "Convertir con un toque",
	HomeFeat8Desc:       "La cotización aprobada se convierte en factura con un toque. Sin volver a escribir.",
	HomeFeat9Title:      "Facturas recurrentes",
	HomeFeat9Desc:       "Configúralo una vez. Las facturas se envían solas cada mes.",
	HomeFeat10Title:     "Recordatorios de pago",
	HomeFeat10Desc:      "¿Pago tardío? Hacemos seguimiento automático para que no tengas que hacerlo tú.",
	HomeSecEyebrow:      "Seguridad",
	HomeSecTitle:        "Los datos de tu negocio son tuyos.",
	HomeSecTitleEm:      "Punto final.",
	HomeSecSub:          "Tus facturas contienen información real — nombres de clientes, montos, detalles del trabajo. Lo construimos para protegerla.",
	HomeSecCard1Title:   "Tu contraseña es irrompible",
	HomeSecCard1Desc:    "Usamos la protección de contraseña más fuerte disponible. Ni nosotros podemos ver tu contraseña. Nadie puede.",
	HomeSecCard2Title:   "Nunca tocamos tu tarjeta",
	HomeSecCard2Desc:    "Los pagos van directo por Stripe. Nunca vemos ni guardamos números de tarjeta. Jamás.",
	HomeSecCard3Title:   "Sin rastreadores. Sin excepciones.",
	HomeSecCard3Desc:    "Sin Google Analytics. Sin Facebook Pixel. Sin redes publicitarias. Tus datos son tuyos — no de los anunciantes.",
	HomeSecCard4Title:   "Bloquea atacantes automáticamente",
	HomeSecCard4Desc:    "¿Demasiados intentos fallidos? La cuenta se bloquea. Los hackers no llegan a ningún lado.",
	HomeSecCard5Title:   "Entra con tu cara",
	HomeSecCard5Desc:    "Face ID y Touch ID disponibles. Más rápido que una contraseña e imposible de robar.",
	HomeSecCard6Title:   "Los enlaces de clientes son privados",
	HomeSecCard6Desc:    "Cada factura o cotización compartida usa un enlace privado único. Solo quien tú enviaste puede abrirlo.",
	HomeSecProofLabel:   "Lo que protege cada cuenta",
	HomeSecProofDesc:    "Contraseñas irrompibles, bloqueo automático, enlaces privados, pagos Stripe, Face ID y cero rastreadores de terceros.",
	HomeSecCTA:          "Lee nuestra descripción completa de seguridad →",
	HomeCtaTitle:        "¿Listo para cobrar?",
	HomeCtaSub:          "Envía tu primera factura o cotización — gratis, en menos de un minuto.",
	HomeCtaStart:        "Empieza Gratis →",
	HomeCtaPricing:      "Ver Precios",
	HomePricingLabel:    "Precios Simples",
	HomePricingTitle:    "Gratis para empezar. Actualiza cuando estés listo.",
	HomePricingSub:      "Sin prueba. Sin tarjeta. Empieza gratis, actualiza cuando necesites más.",
	HomePlanFreeLabel:   "Gratis",
	HomePlanFreePrice:   "$0",
	HomePlanFreeUnit:    "para siempre",
	HomePlanFreeF1:      "5 facturas / mes",
	HomePlanFreeF2:      "3 cotizaciones / mes",
	HomePlanFreeF3:      "5 clientes guardados",
	HomePlanFreeF4:      "3 envíos por correo / mes",
	HomePlanFreeF5:      "Descarga PDF",
	HomePlanGrowLabel:   "Crecimiento",
	HomePlanGrowPrice:   "$8.88",
	HomePlanGrowUnit:    "/ mes — tarifa fundador",
	HomePlanGrowF1:      "15 facturas / mes",
	HomePlanGrowF2:      "15 cotizaciones / mes",
	HomePlanGrowF3:      "15 clientes",
	HomePlanGrowF4:      "Pagos con tarjeta Stripe",
	HomePlanGrowF5:      "Seguimiento de gastos",
	HomePlanProLabel:    "Pro",
	HomePlanProPrice:    "$18.88",
	HomePlanProUnit:     "/ mes",
	HomePlanProF1:       "Todo ilimitado",
	HomePlanProF2:       "Automatización recurrente",
	HomePlanProF3:       "Recordatorios automáticos",
	HomePlanProF4:       "Plantillas avanzadas",
	HomePlanProF5:       "Soporte prioritario",
	HomePricingViewAll:  "Ver Precios Completos →",
